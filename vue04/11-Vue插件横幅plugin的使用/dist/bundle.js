...
//
 ...
 //如果在配置文件里面配置了扩展名省略写法那么这里可以不用写.vue
...
//我们真正的使用vue组件去导入这个功能 实现了template、css和js代码的抽离

new _vue2.default({
	el: '#app',
	template: '<App/>', /* template会替换掉里面的el挂载里面的内容 */
	components: {
		App: _App2.default //对象升级写法，默认会将这个变量名作为Key和Value
	}
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("p", { staticClass: "title" }, [_vm._v(_vm._s(_vm.name))]),
      _vm._v(" "),
      _c("button", [_vm._v("按钮")]),
      _vm._v(" "),
      _c("Cpn")
...
module.exports = __webpack_require__.p + "img/b.3535973e.jpg";
